...
{   
    ...
    //Audio
    public AudioSource audioSource;      // ini yang kamu isi Player (Audio Source)
    public AudioClip footstepClip;       // ini yang kamu isi Run
    public float footstepDelay = 0.4f;  // jeda antar langkah
    ...
    private void FixedUpdate()
    {
        ...
        // cek apakah sedang berjalan & grounded
